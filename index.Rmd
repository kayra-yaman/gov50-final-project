...
author: "Kayra Yaman"
description: "Riches to Refuge: The effect of GDP per capita on the number of refugees a country hosts per year"
output:
...
- Am I treating the per country per time aspect correctly here?
...
```
The scatter plot visualizes the relationship between a country's GDP per capita and the number of refugees it hosts per year. It shows a large cluster of countries per year with a GDP per capita of under US$50,000 and hosting 1 million refugees. The univariate linear regression plotted over it has a slightly positive slope, suggesting that as a country's GDP per capita increases the number of refugees it hosts per year also increases slightly. However, in modelling this relationship, this univariate regression does not control for year or country. 
- Should I show and explain the model summary for this regression too? (eg main coefficient, r2, adj r2, stat significance, etc.)?
- Or, is it possible to plot the multi-variable linear regression over top of the scatter plot instead of the singular variable one?
